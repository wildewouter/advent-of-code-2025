...
func main() {
	...
	case 6:
		RunWithTimer(day06.PartOne, day06.PartTwo, string(data))
	case 7:
		RunWithTimer(day07.PartOne, day07.PartTwo, string(data))
	case 8:
		RunWithTimer(day08.PartOne, day08.PartTwo, string(data))
	default:
